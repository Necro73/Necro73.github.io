var x = Vue.component('card_assembl', 
{
    ...
    <div class="card">
        ...
        <div style="display: -webkit-box;">
            ...
            <div>
                <div style="display:flex; width:90%; height:15px; padding-left:20px; padding-right:20px;">
                ...
                <div style="display:flex; width:90%; height:15px; padding-left:20px; padding-right:20px;">
                    ...
                    <div style="padding-right:12px">
                        <b style="padding-right:20px; padding-left:5px; font-family:Rubik; font-size:12px; font-weight:bold; line-height:20px; color:#7D7D7D">из 1 000 000 RUB</b>
                    </div>
                    <div>
